<?php  
    ...
    if(isset($_POST['update']))
    {
        ...
        }else
        {
            ...
            if(!$select = mysql_query("Select start,end FROM semisterPeriod WHERE date(end) >= '$startDate' AND periodID != '$id' "))
            {
                echo'<div class="alert alert-danger absolue center text-center" role="alert">
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                            <span aria-hidden="true">×</span>
                ...
                {
                    if(!$insert = mysql_query("UPDATE semisterPeriod SET start='$startDate',end='$endDate' WHERE periodID='$id' "))
                    {
                        echo'<div class="alert alert-danger absolue center text-center" role="alert">
                                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                    <span aria-hidden="true">×</span>
                    ...
                    }else
                    {
                        ...
                        echo "<script type='text/javascript'> document.location = 'period.php'; </script>";
                        exit();
                    }
                }
            }
