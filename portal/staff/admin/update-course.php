<?php 
    ...
    if(isset($_GET['id'])){
        ...
        // Get page data
        $query2 = "SELECT c.*,l.level,f.name AS faculty
                    FROM course c
                    LEFT JOIN faculty f
...
<head>
    ...
    <title>Update Course | Administrator | WAKA CMEC</title>
    ...
    <div class="row" style="width:100%;margin-right:auto;margin-left:auto;-webkit-box-shadow:0px 4px 4px 0px rgba(0,0,0,1);-moz-box-shadow:0px 4px 4px 0px rgba(0,0,0,1);box-shadow:0px 4px 4px 0px rgba(0,0,0,1);margin-bottom:5%;overflow:hidden;max-width:960px;">
        ...
        <form method="POST">
            ...
            <div style="padding-top:2px;padding-bottom:2px;background-color:rgb(239,239,239);">
                <h2 style="margin-left:1%;margin-bottom:1%;font-size:16px;color:rgb(1,1,1);font-weight:bold;"><i class="fa fa-refresh"></i> &nbsp;Update Course</h2>
            </div>
            <div class="row" style="padding:10px;">
                <div class="col-md-12">
                    
                    <?php 
                        include 'validate/updateCourse.php';
                    ?>
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="form-group">
                                <label class="control-label">Course: &nbsp;<a class="text-danger">*</a></label>
                                <input class="form-control" type="text" value ="<?php echo $name1['name'];?>" name="course" style="text-transform: capitalize;">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" value ="<?php echo $name1['abbreviation'];?>" placeholder="Acronym" name="acronym" style="text-transform:uppercase;">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                                    ...
                                    ?>
                                        ...
                                        <optgroup label="level of Study">
                                            <?php while ($row = mysql_fetch_array($result)) { ?>
                                                <option value="<?php echo $row['levelID'];?>" <?php if($name1['levelID'] == $row['levelID']){echo 'selected="selected"';}?> > <?php echo $row['level'];?></option>
                                            <?php } ?>
                                        </optgroup>
                                    <?php } ?>
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="years">
                                    ...
                                    <optgroup label="Years of Study">
                                        <option value="1" <?php if($name1['years'] == 1){echo 'selected="selected"';}?> > 1 Year</option>
                                        <option value="2" <?php if($name1['years'] == 2){echo 'selected="selected"';}?> > 2 Years</option>
                                        <option value="3" <?php if($name1['years'] == 3){echo 'selected="selected"';}?> > 3 Years</option>
                                        <option value="4" <?php if($name1['years'] == 4){echo 'selected="selected"';}?> > 4 Years</option>
                                        <option value="5" <?php if($name1['years'] == 5){echo 'selected="selected"';}?> > 5 Years</option>
                                        <option value="6" <?php if($name1['years'] == 6){echo 'selected="selected"';}?> > 6 Years</option>
                                    </optgroup>
                                </select>
                            </div>
                        </div>
