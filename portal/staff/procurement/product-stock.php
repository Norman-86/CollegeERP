...
<head>
    ...
    <title>Product Stock | Procurement | WAKA CMEC</title>
        ...
        <div class="page-content-wrapper">
            <div class="container-fluid"><a class="btn btn-link" role="button" href="#menu-toggle" id="menu-toggle"><i class="fa fa-bars"></i></a>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <hr style="margin:0px;">
                        <h2 class="bg-warning text-warning" style="font-weight:bold;font-style:normal;">The following items are running out of stock</h2>
                        <hr>
                        <div class="row">
