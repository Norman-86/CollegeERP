...
<head>
    ...
    <title>View Received | Procurement | WAKA CMEC</title>
        ...
        <div id="sidebar-wrapper" style="background-color:rgb(21,164,113);">
            <ul class="sidebar-nav">
                ...
                <li style="color:rgb(252,253,254);"> 
                    ...
                    <a class="bg-info">View Received</a>
        ...
        <div class="page-content-wrapper">
            <div class="container-fluid"><a class="btn btn-link" role="button" href="#menu-toggle" id="menu-toggle"><i class="fa fa-bars"></i></a>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <hr style="margin:0px;">
                        <h2 style="font-weight:bold;font-style:normal;">View Received Items</h2>
                        <hr>
                        <div class="row">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="padding:5px;text-align:center;">
                                                            <?php echo '<a href="form-s13.php?id='.$row["No"].'" class="form" target="_blank">'.sprintf('%09d',$row['No']).' </a>'; ?>
                                                        </td>
                                                        ...
                                                        <td style="padding-bottom:2px;text-align:center;">
                                                            <a href="update-received.php?id=<?php echo $row['PSID']?>" class="text-info" style="cursor:pointer;margin-right:5px;"><i class="fa fa-edit"></i></a> | 
                                                            <button class="text-danger" name="delete" value="<?php echo $row['PSID']?>" type="submit" style="cursor:pointer;margin-left:5px;padding:0px 5px 0px 5px;background-color:transparent;border:none;" onClick="return confirm('Sure you want to delete this item?')"><i class="fa fa-trash"></i></button>
                                                        </td>
                                                    </tr>
                                                    <?php } ?>
                                                </tbody>
