...
<head>
    ...
    <title>Add Publisher | Library | WAKA CMEC</title>
                    ...
                    <div id="formdiv">
                        <div class="row" style="margin-right:0px;margin-left:0px;padding-top:5px;padding-bottom:5px;background-color:rgb(239,239,239);">
                            <div class="col-md-12" style="width:100%;height:auto;">
                                <h2 style="height:auto;margin:0px;font-size:16px;color:rgb(1,1,1);font-weight:bold;margin-left:10%;">Add Publisher</h2></div>
                        </div>
                        <?php 
                            include('validate/addPublisher.php'); 
                            ...
                            if(isset($_SESSION['new'])=='True')
                            {
                                echo'<div class="alert alert-success absolue center text-center" role="alert">
                                        ...
                                        <span class="text-success">Publisher added successfully</span>
                                    </div>';
                                    unset($_SESSION['new']); 
                            }
                        ?>
                        <div class="row" style="margin-right:0px;margin-left:0px;padding-top:24px;">
                            ...
                            <div class="col-md-10 col-md-offset-1" style="font-family:Roboto, sans-serif;">
                                <input class="form-control" type="text" name="name" value="<?php echo $name;?>" placeholder="Publisher name" style="margin-left:0px;">
                            </div>
                        </div>
                        <div class="row" style="margin-right:0px;margin-left:0px;padding-top:24px;">
