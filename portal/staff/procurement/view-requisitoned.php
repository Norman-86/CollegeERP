...
<head>
    ...
    <title>View Requisitioned | Procurement | WAKA CMEC</title>
        ...
        <div id="sidebar-wrapper" style="background-color:rgb(21,164,113);">
            <ul class="sidebar-nav">
                ...
                <li style="color:rgb(252,253,254);"> 
                    ...
                    <a class="bg-info">View Requisitions</a>
        ...
        <div class="page-content-wrapper">
            <div class="container-fluid"><a class="btn btn-link" role="button" href="#menu-toggle" id="menu-toggle"><i class="fa fa-bars"></i></a>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <hr style="margin:0px;">
                        <h2 style="font-weight:bold;font-style:normal;">Requisitioned Items</h2>
                        <hr>
                        <div class="row">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="text-align:center;">
                                                            <?php echo '<a href="form-S11.php?id='.$row["RNO"].'" target="_blank">'.sprintf('%09d',$row['RNO']).' </a>'; ?>
