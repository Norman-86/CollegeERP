...
<head>
    ...
    <title>Add Exam | Time Tabler | WAKA CMEC</title>
...
<body style="background-color:rgba(42,63,84,0);">
    ...
    <div class="row" style="width:98%; padding-bottom:3%;margin-right:auto;margin-left:auto;-webkit-box-shadow:0px 4px 4px 0px rgba(0,0,0,1);-moz-box-shadow:0px 4px 4px 0px rgba(0,0,0,1);box-shadow:0px 4px 4px 0px rgba(0,0,0,1);margin-bottom:5%;overflow:hidden;">
        <div style="margin-bottom:1%;padding-top:2px;padding-bottom:2px;background-color:rgb(239,239,239);">
            <h2 style="margin-left:1%;font-size:16px;color:rgb(1,1,1);font-weight:bold;">Add Exam</h2>
        </div>
        <form method="POST">
            <?php 
                ...
                if(isset($_SESSION['success'])=="true"){
                    echo'<div class="alert alert-success absolue center text-center" role="alert">
                            ...
                            <span class="text-success">Exam Successfully Created</span>
                        </div>';
        ...
        <div class="col-md-12" style="margin-bottom:1%;">
                ...
                <div class="col-md-2">
                    ...
                    <?php 
                        if(empty($result3)){
                            echo '<p class="bg-danger text-danger">No records found</p>';
                        }else
                        {
                            while($row = mysql_fetch_array($result3)) {
                    ?>
                        <input class="form-control" type="hidden" hidden="" name="period" readonly value="<?php echo $row['periodID']?>">
                        <input type="text" class="form-control" readonly value="<?php echo date_format(date_create($row['start']),"M,Y").' - '.date_format(date_create($row['end']),"M,Y");?>">
                    <?php }} ?>
                </div>
                ...
                <div class="col-md-2">
                    ...
                    <?php 
                         ...
                         if(isset($_GET['u'])){ 
                         $ua=mysql_query("SELECT abbreviation FROM unit WHERE unitID='".$_GET['u']."'");
                            if(empty($ua)){
                                echo '<input type="text" class="form-control" readonly value="">';
                            }else{
                            while ($rows = mysql_fetch_array($ua)) {
                    ?>
                        <label style="width:100%;">Unit</label>
                        <input type="text" class="form-control" readonly value="<?php echo $rows['abbreviation'];?>">
                     <?php }}} ?>
                </div>
            </div>
                <?php 
                        ...
                        if($_GET['step']==1){   
                            ...
                            if(!isset($_GET['period'])){ 
                                echo'<div class="alert alert-danger absolue center text-center" role="alert">
                                        ...
                                        <span class="text-danger">Error occured while trying to retrieve Semester Period info.!</span>
                                    </div>';
                            }else{
                ?>
                                    ...
                                    <div id="formdiv">
                                        <div class="row" style="margin-right:0px;margin-left:0px;margin-top:-16px;">
                                            <div style="padding-top:2px;padding-bottom:2px;margin-bottom:10px;background-color:rgb(239,239,239);">
                                                <h2 style="margin-left:1%;margin-bottom:1%;font-size:16px;color:rgb(1,1,1);font-weight:bold;">Exam Details</h2>
                                            </div>
                                            <div class="col-md-12">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-md-10" style="margin-bottom:20px;">
                                                    <input type="number" class="form-control" name="no_of_quizes" min="1" value="<?php echo $quiz;?>" placeholder="Total number of questions">
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="col-md-2 text-right" style="margin-bottom:20px;">
                                                ...
                                                <div class="col-md-10">
                                                    <div class="input-group date form_date" data-date="" data-date-format="yyyy-mm-dd" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd" style="margin-bottom:20px;">
                                                        <input type="date" class="form-control" name="start" value="<?php echo $start;?>" placeholder="Start Date (yyyy-mm-dd)">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-md-10">
                                                    <div class="input-group date form_date" data-date="" data-date-format="yyyy-mm-dd" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd" style="margin-bottom:20px;">
                                                        <input type="date" class="form-control" name="deadline" value="<?php echo $deadline;?>" placeholder="Deadline (yyyy-mm-dd)">
                                                        <span class="input-group-addon">
                                                            <span class="fa fa-calendar">
                                                        </span>
                                                    </div>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-md-10" style="margin-bottom:20px;">
                                                    <input type="number" class="form-control" name="time" min="10" value="<?php echo $time;?>" placeholder="Time limit for test (in minutes)">
                                                </div>
                                            </div>
                        ...
                        if($_GET['step']==2){
                            ...
                            if(!isset($_GET['u'])){ 
                                echo'<div class="alert alert-danger absolue center text-center" role="alert">
                                        ...
                                        <span class="text-danger">Error occured while trying to retrieve Unit info.!</span>
                                    </div>';
                            }else
                            if(!isset($_GET['q'])){ 
                                echo'<div class="alert alert-danger absolue center text-center" role="alert">
                                        ...
                                        <span class="text-danger">Error occured while trying to read no. of Quizes.!</span>
                                    </div>';
                            }else
                            if(!isset($_GET['s'])){ 
                                echo'<div class="alert alert-danger absolue center text-center" role="alert">
                                        ...
                                        <span class="text-danger">Error occured while trying to retrieve Exam Start Date.!</span>
                                    </div>';
                            }else
                            if(!isset($_GET['d'])){ 
                                echo'<div class="alert alert-danger absolue center text-center" role="alert">
                                        ...
                                        <span class="text-danger">Error occured while trying to retrieve Exam Deadline.!</span>
                                    </div>';
                            }else
                            if(!isset($_GET['t'])){ 
                                echo'<div class="alert alert-danger absolue center text-center" role="alert">
                                        ...
                                        <span class="text-danger">Error occured while trying to retrieve Exam Time.!</span>
                                    </div>';
                            }else{
                ?>
                        ...
                        <div>
                                <div class="form-group" style="margin-top:30px;">
                                    <div id="formdiv">
                                        <div class="row" style="margin-right:0px;margin-left:0px;margin-top:-16px;">
                                            <div style="padding-top:2px;padding-bottom:2px;margin-bottom:10px;background-color:rgb(239,239,239);">
                                                <h2 style="margin-left:1%;margin-bottom:1%;font-size:16px;color:rgb(1,1,1);font-weight:bold;">Question Details</h2>
                                            </div>
                                            <?php for($i=1;$i<=$_GET['q'];$i++){?>
                                                <div class="col-md-12">
                                                    <div class="col-md-2 text-right" style="margin-bottom:20px;">
                                                        <label>Quiz <?php echo $i; ?> <a style="color:red;">*</a></label>
                                                    </div>
                                                    <div class="col-md-10" style="margin-bottom:20px;">
                                                        <textarea class="form-control" name="quiz[]" required="" placeholder="Write Queiz no. <?php echo $i; ?> here"></textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="col-md-10" style="margin-bottom:20px;">
                                                        <input type="text" class="form-control" name="a[]" required="" value="" required="" placeholder="Enter option a">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="col-md-10" style="margin-bottom:20px;">
                                                        <input type="text" class="form-control" name="b[]" value="" required="" placeholder="Enter option b">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="col-md-10" style="margin-bottom:20px;">
                                                        <input type="text" class="form-control" name="c[]" value="" required="" placeholder="Enter option c">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="col-md-10" style="margin-bottom:20px;">
                                                        <input type="text" class="form-control" name="d[]" value="" required="" placeholder="Enter option d">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="col-md-10" style="margin-bottom:20px;">
                                                        <input type="number" class="form-control" name="marks[]" min="1" value="" required="" placeholder="Enter Marks for Quiz <?php echo $i; ?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <hr>
                                            ...
                                            <div class="col-md-12 text-center">
                                                ...
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                <button name="final" type="submit" style="padding:5px 20px;color:rgb(1,1,1);">Submit</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
