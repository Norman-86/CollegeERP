<?php 
    ...
    if(isset($_GET['id'])){
        ...
        // Get page data
        $query4 = "SELECT * FROM exam WHERE examNo='$id' ORDER BY name ASC ";
...
<head>
    ...
    <title>Add Quiz | Time Tabler | WAKA CMEC</title>
...
<body style="background-color:rgba(42,63,84,0);">
    ...
    <div class="row" style="width:98%; padding-bottom:3%;margin-right:auto;margin-left:auto;-webkit-box-shadow:0px 4px 4px 0px rgba(0,0,0,1);-moz-box-shadow:0px 4px 4px 0px rgba(0,0,0,1);box-shadow:0px 4px 4px 0px rgba(0,0,0,1);margin-bottom:5%;overflow:hidden;">
        <div style="margin-bottom:1%;padding-top:2px;padding-bottom:2px;background-color:rgb(239,239,239);">
            <h2 style="margin-left:1%;font-size:16px;color:rgb(1,1,1);font-weight:bold;">Add Quiz</h2>
        </div>
        <form method="POST">
            <?php 
                ...
                if(isset($_SESSION['success'])=="true"){
                    echo'<div class="alert alert-success absolue center text-center" role="alert">
                            ...
                            <span class="text-success">Quiz Successfully Added</span>
                        </div>';
                ...
                if(isset($_GET['step'])){
                    ...
                    if(date('Y-m-d') > $examDate){
                        echo'<div class="alert alert-danger absolue center text-center" role="alert">
                                <span class="text-danger">You cannot add quiz to exam that has already ended!</span>
                            </div>';
                    }else{ 
                                        ...
                                        <div class="row" style="margin-right:0px;margin-left:0px;margin-top:-16px;">
                                            ...
                                            <div class="col-md-12">
                                                <div class="col-md-2 text-right" style="margin-bottom:20px;">
                                                    <label>No. of Quizes to add<a style="color:red;">*</a></label>
                                                </div>
                                                <div class="col-md-10" style="margin-bottom:20px;">
                                                    <input type="number" class="form-control" min="1" name="no_of_quizes" value="<?php echo $quiz;?>" placeholder="Total number of questions">
                                                </div>
                                            </div>
                                        ...
                                        <div class="row" style="margin-right:0px;margin-left:0px;margin-top:-16px;">
                                            ...
                                            <?php for($i=1;$i<=$_GET['q'];$i++){?>
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="col-md-10" style="margin-bottom:20px;">
                                                        <textarea class="form-control" name="quiz[]" required="" placeholder="Write Quiz <?php echo $i; ?> here"></textarea>
                                                    </div>
                                                </div>
