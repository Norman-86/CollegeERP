...
<head>
    ...
    <title>Add Item | Procurement | WAKA CMEC</title>
        ...
        <div class="page-content-wrapper">
            <div class="container-fluid"><a class="btn btn-link" role="button" href="#menu-toggle" id="menu-toggle"><i class="fa fa-bars"></i></a>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <hr style="margin:0px;">
                        <h2 style="font-weight:bold;font-style:normal;">Add Item</h2>
                        <hr style="margin:0px;">
                        
                        <form method="post" style="margin-top:20px;">
                            <?php 
                                include('validate/addProduct.php'); 
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="product" value="<?php echo $name;?>" placeholder="Enter Item Name" autofocus="">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="capacity">
                                            ...
                                            <optgroup label="Capacity">
                                                <option value="CYL" <?php if($capacity=="CYL"){echo "selected=selected";}?> >Cylinder</option>
                                                <option value="BTL" <?php if($capacity=="BTL"){echo "selected=selected";}?> >Bottles</option>
                                                <option value="Kgs" <?php if($capacity=="Kgs"){echo "selected=selected";}?> >Kilograms</option>
                                                <option value="L" <?php if($capacity=="L"){echo "selected=selected";}?> >Liters</option>
                                                <option value="M" <?php if($capacity=="M"){echo "selected=selected";}?> >Meters</option>
                                                <option value="PKT" <?php if($capacity=="PKT"){echo "selected=selected";}?> >Packets</option>
                                                <option value="PC" <?php if($capacity=="PC"){echo "selected=selected";}?> >Pieces</option>
                                                <option value="Ream" <?php if($capacity=="Ream"){echo "selected=selected";}?> >Ream</option>
                                            </optgroup>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="min" step="any" min="0" value="<?php echo $min;?>" placeholder="Enter Item&#39;s Minimum Quantity" class="form-control" />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group" style="margin-top:20px;">
                                        <button name="save" type="submit" style="padding:5px 20px;color:rgb(1,1,1);margin-right:auto;margin-left:auto;">Add Item</button>
                                    </div>
                                </div>
                            </div>
                        </form>
