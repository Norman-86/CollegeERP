...
<head>
    ...
    <title>Add Supplier | Procurement | WAKA CMEC</title>
        ...
        <div class="page-content-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <hr style="margin:0px;">
                        <h2 style="font-weight:bold;font-style:normal;">Add Supplier</h2>
                        <hr style="margin:0px;">
                        <form method="post" style="margin-top:20px;">
                            <?php 
                                include('validate/addSupplier.php'); 
                                ...
                                if(isset($_SESSION['new'])=='True')
                                {
                                    echo'<div class="alert alert-success absolue center text-center" role="alert">
                                            ...
                                            <span class="text-success">Supplier added successfully</span>
                                        </div>';
                                    unset($_SESSION['new']); 
                                }
                            ?>
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="name" value="<?php echo $name;?>" placeholder="Enter Name" autofocus="">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="address" value="<?php echo $address;?>" placeholder="Enter Address">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="contact1" value="<?php echo $contact1;?>" placeholder="Enter contact" class="form-control" />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="contact2" value="<?php echo $contact2;?>" placeholder="Enter Contact (optional)" class="form-control" />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="email" name="mail" value="<?php echo $mail;?>" placeholder="example@mail.com" >
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group" style="margin-top:20px;">
                                        <button name="save" type="submit" style="padding:5px 20px;color:rgb(1,1,1);margin-right:auto;margin-left:auto;">Add Supplier</button>
                                    </div>
                                </div>
                            </div>
                        </form>
