<?php 
    ...
    $sql = "SELECT * FROM $tableName WHERE staffID ='$staffID' ORDER BY assignmentID DESC";
...
<head>
    ...
    <title>View Assignments | Lecturer | WAKA CMEC</title>
        ...
        <div id="sidebar-wrapper" style="background-color:rgb(62,140,228);">
            <ul class="sidebar-nav">
                ...
                <li style="color:rgb(252,253,254);"> 
                    ...
                    <a class="bg-info">View Assignments</a>
        ...
        <form method="POST">
            <div class="panel panel-default panel-table">
              <div class="panel-heading">
                ...
                <?php
                    include 'validate/delete-assignment.php';
                    ...
                    if(isset($_SESSION['success'])=="true"){
                        echo'<div class="alert alert-success absolue center text-center" role="alert">
                                ...
                                <span class="text-success">Assignment marked successful</span>
                            </div>';
                    ...
                    if(empty($query)){
                        echo'<div class="alert alert-danger absolue center text-center">
                                <strong class="text-danger">Error occured while trying to retrieve assignments</strong>
                            </div>';
                     }else{
                ?>
                ...
                <table class="table table-striped" id="myTable">
                  ...
                  <tbody>
                        ...
                        <tr>  
                            ...
                            <td><?php echo "Year ".$row['YOS'].", Sem.".$row['semister']; ?></td>
                            <td><?php echo $row['abbreviation']; ?></td>
                            <td><?php echo date_format(date_create($row['uploaded']),"d M-Y"); ?></td>
                            ...
                            <td align="center" style="padding-left:2px;padding-right:2px;">
                                <a href="mark.php?id=<?php echo $row['assignmentID']?>" class="text-info"  title="Mark Assignment" role="button"><em class="fa fa-check"></em></a> &nbsp;
                              ...
                              <?php
                                if(date('Y-m-d') > date_format(date_create($row['deadline']),"Y-m-d")){
                              ?>
                                <a title="Edit/Update Assignment" onClick="return alert('Cannot update Assignment past deadline');" role="button"><em class="fa fa-pencil"></em></a>&nbsp; 
                                <button title="Delete Assignment" onClick="return alert('Cannot delete Assignment past deadline');" style="background-color:transparent;border:none;">
                                      <i class="fa fa-trash" style="font-size:14px;"></i>
                                 </button>
                              <?php }else{ ?>
                                <a href="update-assignment.php?id=<?php echo $row['assignmentID']?>" class="text-primary" title="Edit/Update Assignment"  role="button"><em class="fa fa-pencil"></em></a>&nbsp; 
                                <button name="delete" value="<?php echo $row['assignmentID']?>" title="Delete Assignment" onClick="return confirm('Deleting this assignment might alter other CRITICAL records.\nSure you want to delete??');" style="background-color:transparent;border:none;">
