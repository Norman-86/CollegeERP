<?php 
    ...
    if(isset($_GET['id'])){
        ...
        $sql1 = "SELECT * FROM submitted WHERE assignmentID='$id' AND studentID='$studentID' ORDER BY submitted";
        $query1 = mysql_query($sql1);
    }else{
        $sql1 = "SELECT * FROM submitted WHERE studentID='$studentID' ORDER BY submitted";
        $query1 = mysql_query($sql1);
    }
?>
<head>
    ...
    <title>View Submitted Assignment | Student | WAKA CMEC</title>
    ...
    <div class="row" style="width:98%;margin-right:auto;margin-left:auto;-webkit-box-shadow:0px 4px 4px 0px rgba(0,0,0,1);-moz-box-shadow:0px 4px 4px 0px rgba(0,0,0,1);box-shadow:0px 4px 4px 0px rgba(0,0,0,1);margin-bottom:5%;overflow:hidden;">
        <form method="POST">
            <div class="col-md-12" style="margin-bottom:1%;padding-top:2px;padding-bottom:2px;background-color:rgb(239,239,239);">
                <h2 style="margin-left:1%;font-size:16px;color:rgb(1,1,1);font-weight:bold;">View Submitted Assignments</h2>
            </div>
            <?php 
                            ...
                            <tbody>
                                <?php 
                                    if(empty($query1)){
                                        ...
                                        ?>
                                    <tr>  
                                        <td align="center" style="font-size:12px;font-weight:normal;"><?php echo $r++; ?></td>
                                        <td style="font-size:12px;font-weight:normal;"><?php echo date_format(date_create($rw['submitted']),"D d-M, Y.")." ".date(" g:i A", strtotime($rw['submitted'])); ?></td>
                                        <td align="center" style="font-size:12px;font-weight:normal;"><?php echo $rw['totalMarks']; ?></td>
                                        <td align="center" style="font-size:12px;font-weight:normal;"><?php if($rw['marks'] != NULL){echo $rw['marks'];}else{echo "_";} ?></td>
                                        <td align="center" style="font-size:12px;font-weight:normal;">
                                            <?php 
                                                if($rw['percentage'] != NULL){
                                                    echo $rw['percentage']." %";
                                                }else{echo "_";} 
                                            ?>
                                        </td>
