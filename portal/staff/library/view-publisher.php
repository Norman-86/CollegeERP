<?php 
    ...
    // Get page data
    $query1 = "SELECT p.*, COUNT(b.bookID)AS books
               FROM $tableName p
...
<head>
    ...
    <title>View Publisher | Library | WAKA CMEC</title>
...
<body style="background-color:rgba(42,63,84,0);">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navcol-1">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active" role="presentation"><a href="view-publisher.php">Publishers </a></li>
    ...
    <div class="row" style="width:80%;margin-right:auto;margin-left:auto;padding-top:10px;-webkit-box-shadow:0px 4px 4px 0px rgba(0,0,0,1);-moz-box-shadow:0px 4px 4px 0px rgba(0,0,0,1);box-shadow:0px 4px 4px 0px rgba(0,0,0,1);margin-bottom:5%;overflow:hidden;max-width:960px;">
        <form method="POST">
                ...
                if($total_records<=0){
                    ...
                    if(isset($_SESSION['new'])=='True')
                    {
                        echo'<div class="alert alert-success absolue center text-center" role="alert">
                                ...
                                <span class="text-success">Publisher updated successfully</span>
                            </div>';
                            unset($_SESSION['new']); 
                    }
            ...
            ?>
            <div class="col-md-12">
                <h2 style="font-weight:normal;">View Publisher</h2>   
            </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="text-align:center;font-size:12px;font-weight:normal;color:rgb(3,3,3);"> 
                                    <a style="display:block;" href="view-book.php?publisher=<?php echo $row['publisherID']?>">
                                        <?php echo $row['books'];?>
                                    </a>
                                </td>
                                <td style="font-size:12px;font-weight:normal;padding-top:4px;padding-bottom:4px;"> 
                                    <a href="update-publisher.php?id=<?php echo $row['publisherID']?>" title="Edit/Update Publisher">
                                        <i class="fa fa-edit" style="font-size:14px;color:rgb(62,140,228);margin-right:10px;"></i>
                                    </a>
                                    <button name="delete" value="<?php echo $row['publisherID']?>" title="Delete Publisher" onClick="return confirm('Deleting this publisher might cause books to lack publisher\nSure you want to continue?');" style="background-color:transparent;border:none;">
