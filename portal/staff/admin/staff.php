<?php 
    ...
    $query1="SELECT s.*,f.abbreviation AS faculty
            FROM  $tableName s
            LEFT JOIN $tableName2 f
            ON s.facultyID = f.facultyID
            WHERE s.category != 'Admin' ";
...
<head>
    ...
    <title>View Staff | Administrator | WAKA CMEC</title>
    ...
    <div class="row" style="width:98%;margin-right:auto;margin-left:auto;-webkit-box-shadow:0px 4px 4px 0px rgba(0,0,0,1);-moz-box-shadow:0px 4px 4px 0px rgba(0,0,0,1);box-shadow:0px 4px 4px 0px rgba(0,0,0,1);margin-bottom:5%;overflow:hidden;">
        <form method="POST">
            <div class="col-md-12" style="margin-bottom:1%;padding-top:2px;padding-bottom:2px;background-color:rgb(239,239,239);">
                <h2 style="margin-left:1%;font-size:16px;color:rgb(1,1,1);font-weight:bold;">View Staff</h2>
            </div>
            <?php 
                if(isset($_SESSION['success'])=="true"){
                    echo'<div class="col-md-12 alert alert-success absolue center text-center" role="alert">
                            ...
                            <span class="text-success">Staff successfully updated</span>
                        </div>';
                ...
                if(empty($result)){
                    ...
                    include 'validate/deleteStaff.php';
                        ...
                        <table class="table table-striped" id="myTable">
                            <thead style="background-color:rgb(42,63,84);color:rgb(254,255,255);">
                                <tr>
                                    ...
                                    <th>Category</th>
                                    <th>Faculty</th>
                                    <th style="width:90px;"><i class="fa fa-cog ml-3x"></i> </th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php 
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td style="font-size:12px;font-weight:normal;color:rgb(4,4,4);"> <?php echo $row['fname']." ".$row['lname']." ".$row['sname'];?> </td>
                                        <td style="font-size:12px;font-weight:normal;color:rgb(4,4,4);"> <?php echo $row['gender'];?> </td>
                                        <td style="font-size:12px;font-weight:normal;color:rgb(4,4,4);"> <?php echo $row['phone'];?> </td>
                                        <td style="font-size:12px;font-weight:normal;color:rgb(4,4,4);"> <?php echo $row['mail'];?> </td>
                                        <td style="font-size:12px;font-weight:normal;color:rgb(4,4,4);"> <?php echo $row['category'];?> </td>
                                        <td style="font-size:12px;font-weight:normal;color:rgb(4,4,4);"> 
                                            <?php 
                                        ...
                                        <td style="font-size:12px;font-weight:normal;padding-right:0px;"> 
                                            <?php if($row['category']=="Lecturer"){?>
                                                <a href="unit.php?lec=<?php echo $row['staffID']?>" class="text-success" title="Click to assign lecturer to unit">
                                                    <i class="fa fa-check text-success" style="font-size:14px;margin-right:10px;"></i>
                                                </a>
                                            <?php }else{echo '<i class="fa fa-fw text-success" style="font-size:14px;margin-right:10px;"></i>';} ?>
                                            <a href="update-staff.php?id=<?php echo $row['staffID']?>" title="Click to edit/update">
                                                <i class="fa fa-edit" style="font-size:14px;color:rgb(62,140,228);margin-right:10px;"></i>
                                            </a>
                                            <a href="change-password.php?id=<?php echo $row['staffID']?>" title="Click to reset password">
                                                <i class="fa fa-lock" style="font-size:14px;color:#fce01d;margin-right:10px;"></i>
                                            </a>
                                            <button name="delete" value="<?php echo $row['staffID']?>" title="Click to delete" onClick="return confirm('Deleting this staff might alter other CRITICAL records.\nWant to continue?');" style="background-color:transparent;border:none;">
