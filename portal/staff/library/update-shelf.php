...
<head>
    ...
    <title>Update Shelf | Library | WAKA CMEC</title>
        ...
        <?php 
            ...
            }else
            {
                ...
                if($get<=0){
                    ...
                    $query1 = "SELECT * FROM shelf WHERE shelfID=".$get;
                        ...
                        <div id="formdiv">
                            <div class="row" style="margin-right:0px;margin-left:0px;padding-top:5px;padding-bottom:5px;background-color:rgb(239,239,239);">
                                <div class="col-md-12" style="width:100%;height:auto;">
                                    <h2 style="height:auto;margin:0px;font-size:16px;color:rgb(1,1,1);font-weight:bold;margin-left:10%;">Update Shelf</h2></div>
                            </div>
                            <?php 
                                include('validate/updateShelf.php'); 
                            ...
                            ?>
                                <div class="row" style="margin-right:0px;margin-left:0px;padding-top:24px;">
                                    ...
                                    <div class="col-md-10 col-md-offset-1" style="font-family:Roboto, sans-serif;">
                                        <input class="form-control" type="text" name="no" value="<?php echo $rows['no'];?>" placeholder="Enter shelf No." style="margin-left:0px;">
                                    </div>
                                </div>
                                <div class="row" style="margin-right:0px;margin-left:0px;padding-top:24px;">
