...
<head>
    ...
    <title>Update Publisher | Library | WAKA CMEC</title>
    ...
    <div class="container" style="margin-top:10px;">
        <?php 
            ...
            }else
            {
                ...
                if($get<=0){
                    echo'<div class="alert alert-danger absolue center text-center" role="alert">
                            <span class="text-danger">Error occured while trying to retrieve publisher information!</span>
                        </div>';
                }else{    
                    
                    $query1 = "SELECT * FROM publisher WHERE publisherID=".$get;
                        ...
                        <div id="formdiv">
                            <div class="row" style="margin-right:0px;margin-left:0px;padding-top:5px;padding-bottom:5px;background-color:rgb(239,239,239);">
                                <div class="col-md-12" style="width:100%;height:auto;">
                                    <h2 style="height:auto;margin:0px;font-size:16px;color:rgb(1,1,1);font-weight:bold;margin-left:10%;">Update Publisher</h2></div>
                            </div>
                            <?php 
                                include('validate/updatePublisher.php'); 
                                while($rows = mysql_fetch_assoc($result)) {
                            ?>
                                <div class="row" style="margin-right:0px;margin-left:0px;padding-top:24px;">
                                    <div class="col-md-8 col-md-offset-1">
                                        <p style="margin-left:2%;font-family:Roboto, sans-serif;font-size:12px;font-weight:bold;">Publisher Name <a class="text-danger">*<a/></p>
                                    </div>
                                    <div class="col-md-10 col-md-offset-1" style="font-family:Roboto, sans-serif;">
                                        <input class="form-control" type="text" name="name" value="<?php echo $rows['name'];?>" placeholder="Publisher name" style="margin-left:0px;">
                                    </div>
                                </div>
                                <div class="row" style="margin-right:0px;margin-left:0px;padding-top:24px;">
