<?php 
    include'include/session.php';
        ...
        $query="SELECT u.*,f.fname,f.lname,f.sname,f.gender
               FROM unit u
               LEFT JOIN staffunit s
...
<head>
    ...
    <title>View Unit | Student | WAKA CMEC</title>
                        ...
                        <table class="table table-striped" id="myTable">
                            <thead style="background-color:rgb(42,63,84);color:rgb(254,255,255);">
                                <tr>
                                    ...
                                    <th>Unit</th>
                                    <th>Lecturer</th>
                                    <th style="width:100px;">Course Work</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php 
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td style="font-size:12px;font-weight:normal;color:rgb(4,4,4);"> 
                                            <?php 
                                                if($row['gender'] == "Male"){
                                                    echo "<b>Mr.</b> ".$row['fname']." ".$row['lname']." ".$row['sname'];
                                                }else
                                                if($row['gender'] == "Female"){
                                                    echo "<b>Ms.</b> ".$row['fname']." ".$row['lname']." ".$row['sname'];
                                                }else  
                                                if($row['gender'] == "Other"){
                                                    echo $row['fname']." ".$row['lname']." ".$row['sname'];
                                                }else{
                                                    echo "_";
                                                }
                                            ?> 
                                        ...
                                        <td align="center">
                                            <a href="coursework.php?id=<?php echo $row['unitID']?>" class="text-info" title="click to view course work" role="button"><em class="fa fa-eye"></em></a> 
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
