<?php 
    ...
    if(isset($_GET['id'])){
        ...
        $sql = "SELECT * FROM markedAssignments WHERE assignmentID = '$id' AND studentID='$sid' ORDER BY submittedID ASC";
...
<head>
    ...
    <title>Update Marks | Lecturer | WAKA CMEC</title>
                                    ...
                                    <div id="formdiv">
                                                    ...
                                                    ?>
                                                        <tr>  
                                                            ...
                                                            <td>
                                                                ...
                                                                <input type="number" style="width:96%;padding:2px 5px;" name="marks" min="0" max="<?php echo $totalMarks;?>" required="" value="<?php echo $row['marks'];?>" placeholder="enter marks">
                                                            </td>
                                                        </tr>
                                                   <?php }?>
                                                </tbody>
                                        ...
                                        <div class="row" style="margin-right:0px;margin-left:0px;padding-top:10px;">
                                            <div class="col-md-12 text-center">
                                                <button name="updateAssignment" type="submit" style="padding:5px 20px;color:rgb(1,1,1);">Update Mark</button>
                                            </div>
                                        </div>
                                </div>
                            </form>
