...
<head>
    ...
    <title>View Faculty | Admissions | WAKA CMEC</title>
...
<body style="background-color:rgba(42,63,84,0);">
                ...
                <div class="collapse navbar-collapse" id="navcol-1">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active" role="presentation">
                            <a href="view-faculty.php">Faculty</a>
                        </li>
                        <li role="presentation">
                            <a href="view-course.php">Course</a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <div class="row" style="width:98%;margin-right:auto;margin-left:auto;padding-top:10px;-webkit-box-shadow:0px 4px 4px 0px rgba(0,0,0,1);-moz-box-shadow:0px 4px 4px 0px rgba(0,0,0,1);box-shadow:0px 4px 4px 0px rgba(0,0,0,1);margin-bottom:5%;overflow:hidden;">
        <form method="POST">
            ...
            ?>
            <div class="col-md-12">
                <h2 style="font-weight:normal;">View Faculty</h2>
            </div>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td style="text-align:center;font-size:12px;font-weight:normal;color:rgb(3,3,3);"> 
                                            <a style="display:block;" href="view-course.php?id=<?php echo $row['facultyID']?>">
