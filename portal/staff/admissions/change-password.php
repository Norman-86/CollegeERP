<?php 
    ...
    if(isset($_GET['id'])){
        ...
        // Get page data
        $query2 = "SELECT * FROM student WHERE studentID='$staffID'";
...
<head>
    ...
    <title>Reset Student Password | Admissions | WAKA CMEC</title>
    ...
    <div class="row" style="width:80%;margin-right:auto;margin-left:auto;-webkit-box-shadow:0px 4px 4px 0px rgba(0,0,0,1);-moz-box-shadow:0px 4px 4px 0px rgba(0,0,0,1);box-shadow:0px 4px 4px 0px rgba(0,0,0,1);margin-bottom:5%;overflow:hidden;max-width:960px;">
        ...
        <form method="POST">
            <div class="col-md-12" style="padding-top:2px;padding-bottom:2px;background-color:rgb(239,239,239);">
                <h2 style="margin-left:1%;margin-bottom:1%;font-size:16px;color:rgb(1,1,1);font-weight:bold;"><i class="fa fa-lock"></i> &nbsp;Rest Student Password</h2>
            </div>
            <?php 
                if(empty($result2)){
            ...
            <div class="row" style="padding:10px;">
                <div class="col-md-12">
                    <?php 
                        include 'validate/changeStudentPassword.php';
                    ?>
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group">
                                <label class="control-label">Student Name: &nbsp;<a class="text-danger">*</a></label>
                                <input class="form-control" type="text" value ="<?php echo $name1['fname']." ".$name1['lname']." ".$name1['surname'];?>" readonly="" name="name">
                            </div>
                        </div>
                        
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group">
                                <label class="control-label">Admission No.: &nbsp;<a class="text-danger">*</a></label>
                                <input class="form-control" type="text" value ="<?php echo $name1['adm'];?>" readonly="" placeholder="Student Adm No." name="staffNo">
                            </div>
                        </div>
                    </div>
                    <hr>
