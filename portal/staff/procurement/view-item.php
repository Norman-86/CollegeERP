...
<head>
    ...
    <title>View Item | Procurement | WAKA CMEC</title>
        ...
        <div class="page-content-wrapper">
            <div class="container-fluid"><a class="btn btn-link" role="button" href="#menu-toggle" id="menu-toggle"><i class="fa fa-bars"></i></a>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <hr style="margin:0px;">
                        <h2 style="font-weight:bold;font-style:normal;">Items</h2>
                        <hr>
                        <div class="row">
                                            ...
                                            <table class="table table-striped" id="myTable">
                                                <thead style="background-color:#0dc181;color:rgb(252,254,255);">
                                                    <tr>
                                                        <th style="width:90px;padding:3px; color:black;">
                                                            <button  type="submit" name="receive" onClick="return confirm('Sure you want to receive selected items?')">Receive </button>
                                                        </th>
                                                        <th>Item </th>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="padding-top:2px;padding-bottom:2px;text-align:center;">
                                                            <a href="form-s3.php?id=<?php echo $row['PID']?>" target="_blank">
                                                                <i class="fa fa-eye"></i>
                                                            </a>
                                                        </td>
                                                        <td style="padding-top:2px;padding-bottom:2px;text-align:center;">
                                                            <a href="update-item.php?id=<?php echo $row['PID']?>" class="text-info" style="cursor:pointer;margin-right:5px;"><i class="fa fa-edit"></i></a> | 
                                                            <button class="text-danger" name="delete" value="<?php echo $row['PID']?>" type="submit" style="cursor:pointer;margin-left:5px;padding:0px 5px 0px 5px;background-color:transparent;border:none;" onClick="return confirm('Sure you want to delete this item?')"><i class="fa fa-trash"></i></button>
                                                        </td>
                                                    </tr>
                                                    <?php } ?>
                                                </tbody>
