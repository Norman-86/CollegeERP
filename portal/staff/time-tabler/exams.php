...
<head>
    ...
    <title>View Exams | Time Tabler | WAKA CMEC</title>
...
<body style="background-color:rgba(42,63,84,0);">
    ...
    <div class="row" style="width:98%;margin-right:auto;margin-left:auto;-webkit-box-shadow:0px 4px 4px 0px rgba(0,0,0,1);-moz-box-shadow:0px 4px 4px 0px rgba(0,0,0,1);box-shadow:0px 4px 4px 0px rgba(0,0,0,1);margin-bottom:5%;overflow:hidden;">
        ...
        <form method="POST">
            <div class="col-md-12">
            <?php 
                if(isset($_SESSION['add_quiz_success'])=="true"){
                    echo'<div class="alert alert-success absolue center text-center" role="alert">
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true">×</span>
                            </button>
                            <span class="text-success">Question(s) successfully Added to exam</span>
                        </div>';
                        unset($_SESSION['add_quiz_success']); 
                }
                if(isset($_SESSION['update_success'])=="true"){
                    echo'<div class="alert alert-success absolue center text-center" role="alert">
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true">×</span>
                            </button>
                            <span class="text-success">Exam successfully updated</span>
                        </div>';
                                    ...
                                    <tr>
                                        ...
                                        <td style="font-size:12px;font-weight:normal;padding-left:0px;padding-right:0px;"> 
                                            ...
                                            ?>
                                                ...
                                                <a href="" title="Add Quiz" onClick="alert('You are NOT ALLOWED to add quiz to exams that have already ended!');">
                                                    <i class="fa fa-plus-circle" style="font-size:14px;color:rgb(1,1,1);margin-right:10px;"></i>
                                                </a>
                                           ...
                                           <?php }else{ ?>
                                                ...
                                                <a href="add-quiz.php?step=1&id=<?php echo $row['examNo']?>" title="Click to add questions">
                                                    <i class="fa fa-plus-circle" style="font-size:14px;margin-right:10px;"></i>
                                                </a>
                                                <a href="update-exam.php?id=<?php echo $row['examID']?>" title="Click to edit/update">
                                                    <i class="fa fa-edit" style="font-size:14px;color:rgb(62,140,228);margin-right:10px;"></i>
                                                </a>
                                                <button name="deleteExam" value="<?php echo $row['examID']?>" title="Click to delete" onClick="return confirm('Deleting this Exam might alter other CRITICAL records.\nWant to continue?');" style="background-color:transparent;border:none;">
