<?php 
    ...
    $quert="SELECT * FROM assignedunits ORDER BY unit ASC";
    $rest = mysql_query($quert);
    
?>
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>View Assigned Units | Administrator | WAKA CMEC</title>
    ...
    <div class="row" style="width:98%;margin-right:auto;margin-left:auto;-webkit-box-shadow:0px 4px 4px 0px rgba(0,0,0,1);-moz-box-shadow:0px 4px 4px 0px rgba(0,0,0,1);box-shadow:0px 4px 4px 0px rgba(0,0,0,1);margin-bottom:5%;overflow:hidden;">
        <form method="POST">
            <div class="col-md-12" style="margin-bottom:1%;padding-top:2px;padding-bottom:2px;background-color:rgb(239,239,239);">
                    <h2 style="margin-left:1%;font-size:16px;color:rgb(1,1,1);font-weight:bold;">View Assigned Unit</h2>
            </div>
            <?php
                ...
                if(empty($rest)){
                    ...
                    include 'validate/deleteAssigned.php';
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td style="font-size:12px;font-weight:normal;color:rgb(4,4,4);"> <?php echo $row['staffNo'];?> </td>
                                        <td style="font-size:12px;font-weight:normal;color:rgb(4,4,4);"> <?php echo $row['staff'];?> </td>
                                        <td style="font-size:12px;font-weight:normal;"> 
                                            <button name="delete" value="<?php echo $row['assignID']?>" title="Click to delete" onClick="return confirm('Deleting this Assigned Unit/Lecturer might alter other CRITICAL records.\nWant to continue?');" style="background-color:transparent;color:rgb(254,17,2);border:none;">
