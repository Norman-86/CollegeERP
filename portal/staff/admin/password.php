...
<head>
    ...
    <title>Change Password | Administrator | WAKA CMEC</title>
                ...
                <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="password" required="" value="<?php echo $current;?>" placeholder="current password" autocomplete="off" name="currentpass">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="password" required="" value="<?php echo $new;?>"  placeholder="new password" name="newpass" autocomplete="off">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="password" required="" value="<?php echo $confirm;?>" placeholder="confirm new password" name="confirmpass" autocomplete="off">
                            </div>
                        </div>
                    </div>
                    <hr>
                    <div class="row">
                        <div class="col-lg-12 col-md-12 text-center">
                            <button name="update" type="submit" style="padding:5px 20px;color:rgb(1,1,1);">Change Password</button>
                        </div>
                    </div>
                </div>
            </div>
