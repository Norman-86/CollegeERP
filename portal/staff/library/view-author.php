<?php 
    ...
    if(isset($_GET['book'])){
        $bookID = $_GET['book'];
        // Get page data
        $query1 = "SELECT a.*,COUNT(b.ISBN) AS books
                    FROM author a
...
<head>
    ...
    <title>View Author | Library | WAKA CMEC</title>
...
<body style="background-color:rgba(42,63,84,0);">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navcol-1">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active" role="presentation"><a href="view-author.php">Authors </a></li>
    ...
    <div class="row" style="width:80%;margin-right:auto;margin-left:auto;padding-top:10px;-webkit-box-shadow:0px 4px 4px 0px rgba(0,0,0,1);-moz-box-shadow:0px 4px 4px 0px rgba(0,0,0,1);box-shadow:0px 4px 4px 0px rgba(0,0,0,1);margin-bottom:5%;overflow:hidden;max-width:960px;">
        <form method="POST">
            <?php 
                if(empty($result)){
                    ...
                    /*
                     * 
                    include 'validate/issueBook.php';
                    */
                    include 'validate/delete-author.php';
                    ...
                    if(isset($_SESSION['new'])=='True')
                    {
                        echo'<div class="alert alert-success absolue center text-center" role="alert">
                                ...
                                <span class="text-success">Author updated successfully</span>
                            </div>';
                            unset($_SESSION['new']); 
                    }
            ...
            ?>
            <div class="col-md-12">
                <h2 style="font-weight:normal;">View Authors</h2>
            </div>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td style="font-weight:normal;font-size:12px;color:rgb(6,6,6);"> <?php echo $row['name'];?> </td>
                                        <td style="font-size:12px;font-weight:normal;color:rgb(4,4,4);padding-top:4px;padding-bottom:4px;"> <?php echo $row['gender'];?> </td>
                                        <td style="text-align:center;font-size:12px;font-weight:normal;color:rgb(3,3,3);"> 
                                            <a style="display:block;" href="view-book.php?author=<?php echo $row['authorID']?>">
                                                <?php echo $row['books'];?> 
                                            </a>
                                        </td>
                                        <td style="font-size:12px;font-weight:normal;padding-top:4px;padding-bottom:4px;"> 
                                            <a href="update-author.php?id=<?php echo $row['authorID']?>" title="Edit/Update Author">
                                                <i class="fa fa-edit" style="font-size:14px;color:rgb(62,140,228);margin-right:10px;"></i>
                                            </a>
                                            <button name="delete" value="<?php echo $row['authorID']?>" title="Delete Author" onClick="return confirm('Deleting this Author might lead to loss of critical information on books\nSure you want to continue?');" style="background-color:transparent;border:none;">
