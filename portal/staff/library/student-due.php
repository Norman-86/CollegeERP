<?php 
    ...
    $total_records = $pages['num'];
        ...
        // Get page data
        $query1 = "SELECT b.*,r.*,s.adm 
                    FROM studentborrow r 
                    LEFT JOIN  $tableName b
                    ON r.bookID = b.bookID 
                    LEFT JOIN student s
                    ON r.studentID = s.studentID
                    WHERE r.actualReturnDate IS NULL ORDER BY studentborrowID DESC";
...
<head>
    ...
    <title>Student Due Books | Library | WAKA CMEC</title>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navcol-1">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown active"><a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false" href="#"><i class="fa fa-clock-o" style="margin-right:5px;"></i>Due <span class="caret"></span></a>
                            <ul class="dropdown-menu" role="menu" style="background-color:rgb(249,249,249);">
                                <li class="active" role="presentation"><a href="student-due.php">Students </a></li>
        ...
        <form method="POST">
            <?php 
                ...
                if($rowcount<=0){
                    ...
                    include 'validate/return.php';
                    
                    
            ?>
            <div class="col-md-12">
                <div style="font-weight:normal;">
                    <h2 style="float:left;margin-right:5%;">Student Due Books</h2>
                    <button type="submit" name="submit" title="click to return book" style="padding:5px 20px;color:rgb(1,1,1);">Return</button>
                </div>  
            </div>
                                ...
                                ?>
                                    <tr>
                                        <td style="text-align:center">
                                            <input name="checkbox[]" type="checkbox" id="checkbox[]" value="<?php echo $row['studentborrowID']; ?>">
                                        </td>
                                        ...
                                        <td style="font-weight:normal;font-size:12px;color:rgb(6,6,6);"> <?php echo $row['adm'];?> </td>
