...
<head>
    ...
    <title>Student Pre Admission | Admission | WAKA CMEC</title>
                    ...
                    <div id="formdiv">
                        <div class="row" style="margin-right:0px;margin-left:0px;padding-top:5px;padding-bottom:5px;background-color:rgb(239,239,239);">
                            <div class="col-md-12" style="width:100%;height:auto;">
                                <h2 style="height:auto;margin:0px;font-size:16px;color:rgb(1,1,1);font-weight:bold;margin-left:10%;">Pre Admit Student</h2>
                            </div>
                        </div>
                        <?php 
                            include('validate/preAdmit.php'); 
                            ...
                            if(isset($_SESSION['new'])=='True')
                            {
                                echo'<div class="alert alert-success absolue center text-center" role="alert">
                                        ...
                                        <span class="text-success">Student pre-admitted successfully</span>
                                    </div>';
                                    unset($_SESSION['new']); 
                            }
                        ?>
                        <div class="row" style="margin-right:0px;margin-left:0px;padding-top:24px;">
                            <div class="col-md-4">
                                ...
                                <input class="form-control" type="text" name="surname" value="<?php echo $surname;?>" placeholder="Enter Surname (Optional)" style="margin-left:0px;font-family:Roboto, sans-serif;">
                            </div>
                            <div class="col-md-4">
                                <p style="font-family:Roboto, sans-serif;font-size:12px;font-weight:bold;">First Name <a class="text-danger">*<a/></p>
                                <input class="form-control" type="text" name="fname" value="<?php echo $fname;?>" placeholder="Enter First Name" style="margin-left:0px;font-family:Roboto, sans-serif;">
                            </div>
                            <div class="col-md-4">
                                <p style="font-family:Roboto, sans-serif;font-size:12px;font-weight:bold;">Other Names <a class="text-danger">*<a/></p>
                                <input class="form-control" type="text" name="lname" value="<?php echo $lname;?>" placeholder="Enter Other Names" style="margin-left:0px;font-family:Roboto, sans-serif;">
                            </div>
                        </div>
                        <div class="row" style="margin-right:0px;margin-left:0px;padding-top:24px;">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group date form_date" data-date="" data-date-format="yyyy-mm-dd" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
                                    <input class="form-control" type="date" name="dob" value="<?php echo $dob;?>" placeholder="Date of Birth (yyyy-mm-dd)" style="margin-left:0px;">
                            ...
                            <div class="col-md-4">
                                <p style="margin-left:2%;font-family:Roboto, sans-serif;font-size:12px;font-weight:bold;">National ID No. (Optional)</p>
                        ...
                        <div class="row" style="margin-right:0px;margin-left:0px;padding-top:24px;">
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    <input class="form-control" type="text" name="phone1" value="<?php echo $phone1;?>" placeholder="Enter phone number" style="margin-left:0px;">
                                    <span class="input-group-addon">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    <input class="form-control" type="text" name="phone2" value="<?php echo $phone2;?>" placeholder="Alternative phone number (optional)" style="margin-left:0px;">
                                    <span class="input-group-addon">
                                        <i class="fa fa-phone"></i>
                                    </span>
                                </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    <input class="form-control" type="email" name="mail" value="<?php echo $mail;?>" placeholder="Enter mail (optional)" style="margin-left:0px;">
                                    <span class="input-group-addon">
                        ...
                        <div class="row" style="margin-right:0px;margin-left:0px;padding-top:24px;font-family:Roboto, sans-serif;font-size:12px;">
                            ...
                            <div class="col-md-2">
                                ...
                                <select class="form-control" id="yos" required name="yos">
                                    <?php
                                        if($course){
                        ...
                        <div class="row" style="margin-right:0px;margin-left:0px; text-align:center; padding-top:24px;">
                            <div class="col-md-12">
                                <button type="submit" name="submit" style="padding:5px 20px;color:rgb(1,1,1);">Pre Admit </button>
                            </div>
                        </div>
                    </div>
                </div>
