<?php 
    ...
    // Get page data
    $query1 = "SELECT st.*,s.staffNo FROM $tableName st LEFT JOIN staff s ON st.staffID = s.staffID ORDER BY st.fname ASC";
...
<head>
    ...
    <title>Pre Admitted Students | Principal| WAKA CMEC Training Institute</title>
                ...
                <div class="collapse navbar-collapse" id="navcol-1">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown active">
                            ...
                            <ul class="dropdown-menu" role="menu" style="background-color:rgb(249,249,249);">
                                <li class="active" role="presentation"><a href="view-preadmitted.php">Pre-Admitted </a></li>
    ...
    <div class="row" style="width:98%;margin-right:auto;margin-left:auto;-webkit-box-shadow:0px 4px 4px 0px rgba(0,0,0,1);-moz-box-shadow:0px 4px 4px 0px rgba(0,0,0,1);box-shadow:0px 4px 4px 0px rgba(0,0,0,1);margin-bottom:5%;overflow:hidden;">
        <form method="POST">
            <div class="col-md-12" style="margin-bottom:1%;padding-top:2px;padding-bottom:2px;background-color:rgb(239,239,239);">
                <div class="col-md-12">
                    <h2 style="margin-left:1%;font-size:16px;color:rgb(1,1,1);font-weight:bold;">Pre Admitted Students</h2>
                </div>
            </div>
            <?php 
                if($total_records<=0){
