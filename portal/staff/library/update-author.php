...
<head>
    ...
    <title>Update Author | Library | WAKA CMEC</title>
        ...
        <div class="container-fluid">
            <div class="navbar-header">
                <a class="navbar-brand navbar-link" href="#" style="font-weight:bold;background-color:rgb(52,73,94);">
                    Library | Waka CMEC Training Institute
                </a>
                <button class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navcol-2" style="background-color:rgb(52,73,94);color:rgb(255,255,255);">
            ...
            <div class="collapse navbar-collapse" id="navcol-2">
                <ul class="nav navbar-nav hidden-xs hidden-sm navbar-right" id="desktop-toolbar">
                    <li class="dropdown">
                        <a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false" href="#"> 
                            <i class="fa fa-user"></i> &nbsp; <?php echo $pro;?>  
                ...
                <ul class="nav navbar-nav visible-xs-block visible-sm-block" id="mobile-nav">
                    ...
                    <li class="dropdown">
                        <a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false" href="#"> 
                            <i class="fa fa-user"></i> &nbsp; <?php echo $pro;?> </i> 
                            <i class="fa fa-chevron-down fa-fw"></i>
                        </a>
                        <ul class="dropdown-menu" role="menu" style="background-color:rgb(249,249,249);">
                            <li role="presentation"><a href="settings.php"><i class="fa fa-user fa-fw"></i> Profile </a></li>
    ...
    <div class="container" style="margin-top:10px;">
        <?php 
            ...
            }else
            {
                ...
                if($get<=0){
                    echo'<div class="alert alert-danger absolue center text-center" role="alert">
                            <span class="text-danger">Error occured while trying to retrieve author information!</span>
                        </div>';
                }else{    
                    
                    $query1 = "SELECT * FROM author WHERE authorID=".$get;
                    ...
                    <div id="formdiv">
                        <div class="row" style="margin-right:0px;margin-left:0px;padding-top:5px;padding-bottom:5px;background-color:rgb(239,239,239);">
                            <div class="col-md-12" style="width:100%;height:auto;">
                                <h2 style="height:auto;margin:0px;font-size:16px;color:rgb(1,1,1);font-weight:bold;margin-left:10%;">Update Author</h2>
                            </div>
                        </div>
                        <?php
                            include('validate/updateAuthor.php'); 
                        ?>
                        <div class="row" style="margin-right:0px;margin-left:0px;padding-top:24px;">
                            <div class="col-md-8 col-md-offset-1">
                                <p style="margin-left:2%;font-family:Roboto, sans-serif;font-size:12px;font-weight:bold;">Author Name <a class="text-danger">*<a/></p>
                            </div>
                            <div class="col-md-10 col-md-offset-1" style="font-family:Roboto, sans-serif;">
                                <input class="form-control" type="text" name="name" value="<?php echo $rows['name'];?>" placeholder="Name" style="margin-left:0px;">
                            </div>
                        </div>
                        <div class="row" style="margin-right:0px;margin-left:0px;padding-top:24px;">
                            <div class="col-md-8 col-md-offset-1">
                            ...
                            <div class="col-md-10 col-md-offset-1" style="font-family:Roboto, sans-serif;font-size:12px;">
                                <select class="form-control" name="gender">
                                    ...
                                    <optgroup label="Gender">
                                        ...
                                        <option value="Other" <?php if($rows['gender']=="Other"){echo "selected=selected";}?> >Other</option>
                                    </optgroup>
                                </select>
                            </div>
                        </div>
