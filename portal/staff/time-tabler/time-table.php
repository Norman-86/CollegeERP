...
<body style="background-color:rgba(42,63,84,0);">
    ...
    <div class="row" style="width:98%;margin-right:auto;margin-left:auto;-webkit-box-shadow:0px 4px 4px 0px rgba(0,0,0,1);-moz-box-shadow:0px 4px 4px 0px rgba(0,0,0,1);box-shadow:0px 4px 4px 0px rgba(0,0,0,1);margin-bottom:5%;overflow:hidden;">
        ...
        <div class="col-md-12" style="margin-bottom:1%;">
                ...
                <?php if(isset($_GET['cid']) && isset($_GET['yos']) && isset($_GET['sem']) && isset($_GET['period'])){ ?>
                <div class="col-md-12">
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <tr style="border-bottom:1px solid grey;">
                                    <td style="font-weight:normal;font-size:12px;color:rgb(6,6,6);">1</td>
                                        <td style="font-weight:normal;font-size:12px;color:rgb(6,6,6);">
                                            <select class="form-control" name="start[]">
                                                <option value="">- Start Time -</option>
                                                <optgroup label="AM">
                                                    <option value="07:00" <?php //if($gender=="Male"){echo "selected=selected";}?> >7:00 AM</option>
                                                    <option value="08:00" <?php //if($gender=="Female"){echo "selected=selected";}?> >8:00 AM</option>
                                                    <option value="09:00" <?php //if($gender=="Female"){echo "selected=selected";}?> >9:00 AM</option>
                                                    <option value="10:00" <?php //if($gender=="Female"){echo "selected=selected";}?> >10:00 AM</option>
                                                    <option value="11:00" <?php //if($gender=="Female"){echo "selected=selected";}?> >11:00 AM</option>
                                                    <option value="12:00" <?php //if($gender=="Female"){echo "selected=selected";}?> >12:00 AM</option>
                                                </optgroup>
                                                <optgroup label="PM">
                                                    <option value="13:00" <?php //if($gender=="Female"){echo "selected=selected";}?> >1:00 PM</option>
                                                    <option value="14:00" <?php //if($gender=="Female"){echo "selected=selected";}?> >2:00 PM</option>
                                                    <option value="15:00" <?php //if($gender=="Female"){echo "selected=selected";}?> >3:00 PM</option>
                                                    <option value=16:00" <?php //if($gender=="Female"){echo "selected=selected";}?> >4:00 PM</option>
                                                    <option value="17:00" <?php //if($gender=="Female"){echo "selected=selected";}?> >5:00 PM</option>
                                                </optgroup>
                                            </select>
                                            <br>
                                            ...
                                            <select class="form-control" id="course" name="monday_unit[]">
                                                ...
                                                ?>
                                                        <option value="<?php echo $row['unitID']; ?>"
                                                            <?php if($monday_unit==$row['unitID']){ echo "selected='selected'";}?> > 
                                                                <?php echo $row['name']; ?> 
                                                        </option>
                                                <?php
                                                        }
                                                ...
                                                <optgroup label="Class">
                                                    ...
                                                    ?>
                                                        <option value="<?php echo $row['classID'];?>" 
                                                            <?php if($monday_class==$row['classID']){ echo "selected='selected'";}?> >
                                                                <?php echo $row['name'];?>
                                                        </option>
                                                    <?php }} ?>
                                                </optgroup>
                                        ...
                                        <td style="text-align:center;font-weight:normal;font-size:12px;color:rgb(6,6,6);">
                                            <select class="form-control" id="course" name="tuesday_unit[]">
                                                ...
                                                ?>
                                                        <option value="<?php echo $row['unitID']; ?>"
                                                            <?php if($tuesday_unit==$row['unitID']){ echo "selected='selected'";}?> > 
                                                                <?php echo $row['name']; ?> 
                                                        </option>
                                                <?php
                                                        }
                                            ...
                                            <select class="form-control" name="tuesday_class[]">
                                                ...
                                                <optgroup label="Class">
                                                    ...
                                                    ?>
                                                        <option value="<?php echo $row['classID'];?>" 
                                                            <?php if($tuesday_class==$row['classID']){ echo "selected='selected'";}?> >
                                                                <?php echo $row['name'];?>
                                                        </option>
                                                    <?php }} ?>
                                                </optgroup>
                                        ...
                                        <td style="text-align:center;font-weight:normal;font-size:12px;color:rgb(6,6,6);">
                                            <select class="form-control" id="course" name="wednesday_unit[]">
                                                ...
                                                ?>
                                                        <option value="<?php echo $row['unitID']; ?>"
                                                            <?php if($wednesday_unit==$row['unitID']){ echo "selected='selected'";}?> > 
                                                                <?php echo $row['name']; ?> 
                                                        </option>
                                                <?php
                                                        }
                                            ...
                                            <select class="form-control" name="wednesday_class[]">
                                                ...
                                                <optgroup label="Class">
                                                    ...
                                                    ?>
                                                        <option value="<?php echo $row['classID'];?>" 
                                                            <?php if($wednesday_class==$row['classID']){ echo "selected='selected'";}?> >
                                                                <?php echo $row['name'];?>
                                                        </option>
                                                    <?php }} ?>
                                                </optgroup>
                                        ...
                                        <td style="text-align:center;font-weight:normal;font-size:12px;color:rgb(6,6,6);">
                                            <select class="form-control" id="course" name="thursday_unit[]">
                                                ...
                                                ?>
                                                        <option value="<?php echo $row['unitID']; ?>"
                                                            <?php if($thursday_unit==$row['unitID']){ echo "selected='selected'";}?> > 
                                                                <?php echo $row['name']; ?> 
                                                        </option>
                                                <?php
                                                        }
                                            ...
                                            <select class="form-control" name="thursday_class[]">
                                                ...
                                                <optgroup label="Class">
                                                    ...
                                                    ?>
                                                        <option value="<?php echo $row['classID'];?>" 
                                                            <?php if($thursday_class==$row['classID']){ echo "selected='selected'";}?> >
                                                                <?php echo $row['name'];?>
                                                        </option>
                                                    <?php }} ?>
                                                </optgroup>
                                        ...
                                        <td style="text-align:center;font-weight:normal;font-size:12px;color:rgb(6,6,6);">
                                            <select class="form-control" id="course" name="friday_unit[]">
                                                ...
                                                ?>
                                                        <option value="<?php echo $row['unitID']; ?>"
                                                            <?php if($friday_unit==$row['unitID']){ echo "selected='selected'";}?> > 
                                                                <?php echo $row['name']; ?> 
                                                        </option>
                                                <?php
                                                        }
                                            ...
                                            <select class="form-control" name="friday_class[]">
                                                ...
                                                <optgroup label="Class">
                                                    ...
                                                    ?>
                                                        <option value="<?php echo $row['classID'];?>" 
                                                            <?php if($friday_class==$row['classID']){ echo "selected='selected'";}?> >
                                                                <?php echo $row['name'];?>
                                                        </option>
                                                    <?php }} ?>
                                                </optgroup>
                                    ...
                                    <tr style="border-bottom:1px solid grey;">
                                        <td style="font-weight:normal;font-size:12px;color:rgb(6,6,6);">2</td>
                                        <td style="font-weight:normal;font-size:12px;color:rgb(6,6,6);"> 
                                            <select class="form-control" name="start[]">
                                                <option value="">- Start Time -</option>
                                                <optgroup label="AM">
                                    ...
                                    <tr style="border-bottom:1px solid grey;">
                                        <td style="font-weight:normal;font-size:12px;color:rgb(6,6,6);">3</td>
                                        <td style="font-weight:normal;font-size:12px;color:rgb(6,6,6);"> 
                                            <select class="form-control" name="start[]">
                                                <option value="">- Start Time -</option>
                                                <optgroup label="AM">
                                    ...
                                    <tr style="border-bottom:1px solid grey;">
                                        <td style="font-weight:normal;font-size:12px;color:rgb(6,6,6);">4</td>
                                        <td style="font-weight:normal;font-size:12px;color:rgb(6,6,6);"> 
                                            <select class="form-control" name="start[]">
                                                <option value="">- Start Time -</option>
                                                <optgroup label="AM">
    ...
    //add row to table
    function add() {
        $("table").append('<tr><td style="font-weight:normal;font-size:12px;color:rgb(6,6,6);">1</td><td style="text-align:center;font-size:12px;font-weight:normal;color:rgb(4,4,4);">2</td><td style="text-align:center;font-weight:normal;font-size:12px;color:rgb(6,6,6);">3</td><td style="text-align:center;font-weight:normal;font-size:12px;color:rgb(6,6,6);">4</td><td style="text-align:center;font-weight:normal;color:rgb(6,6,6);padding:0px;"><button type="button" value="Delete" onclick="deleteRow(this)" style="background-color:transparent;border:none;"><i class="fa fa-times text-danger"></i></button></td></tr>');
    }
    </script>
</html>