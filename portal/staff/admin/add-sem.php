...
<head>
    ...
    <title>Add Semester Period | Administrator | WAKA CMEC</title>
                    ...
                    <?php 
                        ...
                        if(isset($_SESSION['success'])=="true"){
                            echo'<div class="alert alert-success absolue center text-center" role="alert">
                                    ...
                                    <span class="text-success">Semister Period successfull</span>
                                </div>';
                    ...
                    <div class="row">
                        <div class="col-md-5 col-sm-12">
                            <div class="form-group">
                                ...
                                <div class="input-group date form_date" data-date="" data-date-format="yyyy-mm-dd" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
                                    <input class="form-control" type="date" required="" value='<?php echo $start; ?>' placeholder="yyyy-mm-dd" name="start" autocomplete="off">
                        ...
                        <div class="col-md-5 col-sm-12">
                            <div class="form-group">
                                ...
                                <div class="input-group date form_date" data-date="" data-date-format="yyyy-mm-dd" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
                                    <input class="form-control" type="date" required="" value='<?php echo $end; ?>' placeholder="yyyy-mm-dd" name="end" autocomplete="off">
                                    <span class="input-group-addon">
                                        <span class="fa fa-calendar">
                                    </span>
                                </div>
                        ...
                        <div class="col-md-2 col-sm-12">
                            <div class="form-group">
                                ...
                                <button name="submit" type="submit" style="padding:5px 20px;color:rgb(1,1,1);">
