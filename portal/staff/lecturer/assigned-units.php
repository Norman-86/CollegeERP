<?php 
    ...
    $sql = "SELECT * FROM $tableName WHERE staffID ='$staffID' ORDER BY unit DESC";
...
<head>
    ...
    <title>Assigned Units | Lecturer | WAKA CMEC</title>
    ...
    <div id="wrapper">
        <div id="sidebar-wrapper" style="background-color:rgb(62,140,228);">
            <ul class="sidebar-nav">
                <li class="sidebar-brand" style="color:rgb(255,255,255);"> <a href="#" style="font-weight:bold;color:rgb(254,254,254);">Lecturer | WAKA CMEC</a></li>
              ...
              <div class="panel-heading">
                <div class="row">
                  <div class="col col-xs-12">
                    <h3 class="panel-title"><em class="fa fa-book"></em> <b>Assigned Units</b></h3>
                  </div>
                </div>
              </div>
                  ...
                  <tbody>
                        <?php 
                          ...
                          <tr>
                            ...
                            <td align="center"><?php echo "Year ".$row['YOS'].", Sem. ".$row['sem']; ?></td>
                            <td><?php echo $row['faculty']; ?></td>
                            <td align="center">
                                <a href="course-work.php?id=<?php echo $row['unitID']?>" class="text-info"  role="button"><em class="fa fa-eye"></em></a> 
                            </td>
                          </tr>
                        <?php }}?>  
                    </tbody>
