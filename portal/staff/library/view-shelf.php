<?php 
    ...
    // Get page data
    $query1 = "SELECT s.*,COUNT(b.bookID)AS books
               FROM $tableName s
...
<head>
    ...
    <title>View Shelf | Library | WAKA CMEC</title>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navcol-1">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active" role="presentation"> <a href="view-shelf.php">Shelves </a></li>
        ...
        <form method="POST">
            <?php 
                if($rowcount<=0){
                    ...
                    include 'validate/delete-shelf.php';
                    ...
                    if(isset($_SESSION['new'])=='True')
                    {
                        echo'<div class="alert alert-success absolue center text-center" role="alert">
                                ...
                                <span class="text-success">Shelf updated successfully</span>
                            </div>';
                            unset($_SESSION['new']); 
                    }
            ...
            ?>
            <div class="col-md-12">
                <h2 style="font-weight:normal;">View Shelves</h2>  
            </div>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td style="text-align:center;font-weight:normal;font-size:12px;color:rgb(6,6,6);"> <?php echo $row['no'];?> </td>
                                        <td style="text-align:center;font-size:12px;font-weight:normal;color:rgb(4,4,4);padding-top:4px;padding-bottom:4px;"> 
                                            <a style="display:block;" href="view-book.php?shelf=<?php echo $row['shelfID']?>">
                                                <?php echo $row['books'];?> 
                                            </a>    
                                        </td>
                                        <td style="font-size:12px;font-weight:normal;padding-top:4px;padding-bottom:4px;"> 
                                            <a href="update-shelf.php?id=<?php echo $row['shelfID']?>" title="Edit/Update Shelf">
                                                <i class="fa fa-edit" style="font-size:14px;color:rgb(62,140,228);margin-right:10px;"></i>
                                            </a>
                                            <button name="delete" value="<?php echo $row['shelfID']?>" title="Delete Shelf" onClick="return confirm('Deleting this shelf shall render all books assigned to it shelfless!\nwant to continue?');" style="background-color:transparent;border:none;">
