<?php
    ...
    if(isset($_SESSION['category'])==="Principal")
    { 
        header("location:../../staff/principal/index.php");
    }else
    ...
    //select faculty
    $faculty = "SELECT facultyID,name FROM faculty ORDER BY name ASC";
    $dept = mysql_query($faculty);
    
    //select faculty
    $assignedUnits = "SELECT * FROM assignedunit WHERE staffID='$staffID' ORDER BY unit ASC";
    $au = mysql_query($assignedUnits);
?>