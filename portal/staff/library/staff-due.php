...
<head>
    ...
    <title>Staff Due Books | Library | WAKA CMEC</title>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown active"><a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false" href="#"><i class="fa fa-clock-o" style="margin-right:5px;"></i>Due <span class="caret"></span></a>
                            <ul class="dropdown-menu" role="menu" style="background-color:rgb(249,249,249);">
                                ...
                                <li class="active" role="presentation"><a href="staff-due.php">Staff </a></li>
                            </ul>
                        </li>
        ...
        <form method="POST">
            ...
            <div class="col-md-12">
                <div style="font-weight:normal;">
                    <h2 style="float:left;margin-right:5%;">Staff Due Books</h2>
                    <button type="submit" name="staff_submit" title="click to return book" style="padding:5px 20px;color:rgb(1,1,1);">Return</button>
                </div>  
            </div>
                                ...
                                ?>
                                    <tr>
                                        <td style="text-align:center">
                                            <input name="checkbox[]" type="checkbox" id="checkbox[]" value="<?php echo $row['staffborrowID']; ?>">
                                        </td>
