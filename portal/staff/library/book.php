...
<head>
    ...
    <title>Add Book | Library | WAKA CMEC</title>
                    ...
                    <div id="formdiv">
                        <div class="row" style="margin-right:0px;margin-left:0px;padding-top:5px;padding-bottom:5px;background-color:rgb(239,239,239);">
                            <div class="col-md-12" style="width:100%;height:auto;">
                                <h2 style="height:auto;margin:0px;font-size:16px;color:rgb(1,1,1);font-weight:bold;margin-left:10%;">Add Book</h2>
                            </div>
                        </div>
                        <?php 
                            include('validate/addBook.php'); 
                        ...
                        <div class="row" style="margin-right:0px;margin-left:0px;padding-top:24px;">
                            ...
                            <div class="col-md-10 col-md-offset-1" style="font-family:Roboto, sans-serif;">
                                <input class="form-control" type="text" name="title" value="<?php echo $title;?>" placeholder="Enter book title" style="margin-left:0px;">
                            </div>
                        </div>
                        <div class="row" style="margin-right:0px;margin-left:0px;padding-top:24px;">
                            <div class="col-md-8 col-md-offset-1">
                            ...
                            <div class="col-md-10 col-md-offset-1" style="font-family:Roboto, sans-serif;">
                                <input class="form-control" type="text" name="isbn" value="<?php echo $isbn;?>" placeholder="Enter book ISBN No." style="margin-left:0px;">
                            </div>
                        </div>
                        <div class="row" style="margin-right:0px;margin-left:0px;padding-top:24px;">
                            <div class="col-md-8 col-md-offset-1">
                                ...
                                <select class="form-control" name="category">
                                    ...
                                    <optgroup label="Category">
                                        <?php while ($row = mysql_fetch_array($result)) { ?>
                                          <option value="<?php echo $row['categoryID'];?>" <?php if($row['categoryID']=="$category"){echo "selected=selected";}?> ><?php echo $row['name'];?></option>
                                        <?php } ?>
                                    </optgroup>
                                </select>
                                <?php } ?>
                        ...
                        <div class="row" style="margin-right:0px;margin-left:0px;padding-top:24px;">
                            <div class="col-md-8 col-md-offset-1">
                                <p style="margin-left:2%;font-family:Roboto, sans-serif;font-size:12px;font-weight:bold;">Publisher <a class="text-danger">*<a/></p>
                            </div>
                            <div class="col-md-10 col-md-offset-1" style="font-family:Roboto, sans-serif;font-size:12px;">
                                <?php
                                ...
                                <select class="form-control" name="publisher">
                                    ...
                                    <optgroup label="Category">
                                        <?php while ($row1 = mysql_fetch_array($result1)) { ?>
                                          <option value="<?php echo $row1['publisherID'];?>" <?php if($row1['publisherID']=="$publisher"){echo "selected=selected";}?> ><?php echo $row1['name'];?></option>
                                        <?php } ?>
                                    </optgroup>
                                </select>
                                <?php } ?>
                                ...
                                <select class="form-control" name="shelf">
                                    ...
                                    <optgroup label="Shelf No.">
                                        <?php while ($row2 = mysql_fetch_array($result2)) { ?>
                                          <option value="<?php echo $row2['shelfID'];?>" <?php if($row2['shelfID']=="$shelf"){echo "selected=selected";}?> ><?php echo $row2['no'];?></option>
                                        <?php } ?>
                                    </optgroup>
                                </select>
                                <?php } ?>
