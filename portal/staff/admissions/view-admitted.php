                ...
                if($total_records<=0){
                    ...
                    if(isset($_SESSION['new'])=='True')
                    {
                        echo'<div class="alert alert-success absolue center text-center" role="alert">
                                ...
                                <span class="text-success">Student updated successfully</span>
                            </div>';
                            unset($_SESSION['new']); 
                    }
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="font-size:12px;font-weight:normal;padding-top:4px;padding-bottom:4px;"> 
                                    <a href="update-student.php?id=<?php echo $row['studentID']?>" title="Update Student Details">
                                        <i class="fa fa-edit" style="font-size:14px;color:rgb(62,140,228);margin-right:10px;"></i>
                                    </a>
                                    <a href="change-password.php?id=<?php echo $row['studentID']?>" title="Click to reset student password">
